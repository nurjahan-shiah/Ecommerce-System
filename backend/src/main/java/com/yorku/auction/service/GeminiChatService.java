...
public class GeminiChatService {
    ...
    public String chat(String userMessage, String context) {
        ...
        prompt.append("You are Atlas AI for a forward auction platform. ")
              ...
              .append("Match your response length to the question: short casual messages get 1-2 sentence replies, ")
              .append("detailed questions get thorough answers. Never pad or over-explain. ")
              .append("Be direct and friendly.\n\n");
        if (context != null && !context.isBlank()) {
            String trimmedContext = context.length() > 2000 ? context.substring(0, 2000) : context;
