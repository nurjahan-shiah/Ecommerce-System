...
-- User 4 as WINNER auction (ENDED + ready for payment)
...
-- 3. ENDED AUCTION - Auction ID ~5 (User 4 won, ready for UC4 testing)
...
-- BIDS HISTORY for ENDED auction (User 4's winning bids)
...
-- PAYMENT for ENDED auction (completed payment)
...
VALUES (5, (SELECT user_id FROM users WHERE username = 'testuser4'), 1295.00, '4111111111111111', 
        'Winner User', 1, 'COMPLETED', '2026-02-28 10:05:00');

-- 4. COMPLETED AUCTION - Auction ID ~6 (User 4 already paid)
INSERT OR IGNORE INTO catalogue_items (item_name, description, starting_price, shipping_price, 
                                       expedited_shipping_price, shipping_days, keywords) 
